/** 
 * @Title: TranslateChinese2PinYin.java 
 * @Package com.tiyi.collectorCenter.common.tool 
 * @Description: TODO
 * @author luoyang
 * @date 2015-7-21 下午1:57:03 
 * @version V1.0 
 */
...
public class Chinese2PinYin {
	private final int[] FIRST_TABLE = { 45217, 45253, 45761, 46318, 46826, 47010, 47297, 47614, 47614, 48119, 49062,
			49324, 49896, 50371, 50614, 50622, 50906, 51387, 51446, 52218, 52218, 52218, 52698, 52980, 53689, 54481,
			55289 };

	private final String[] ALL_VALUE = { "zuo", "zun", "zui", "zuan", "zu", "zou", "zong", "zi", "zhuo", "zhun", "zhui",
	...
	private final int[] ALL_CODE = { -10254, -10256, -10260, -10262, -10270, -10274, -10281, -10296, -10307, -10309,
	...
	public static void main(String[] args) {
		String str = "你好，Hello！";
		Chinese2PinYin py = new Chinese2PinYin();
		String strPinYin = py.getAllPY(str);
		String strPinYinFirst = py.getFirstPY(str);
		System.out.println(strPinYin + " " + strPinYinFirst);
	}
}
